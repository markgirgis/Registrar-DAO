...
public class CourseDAOImpl implements CourseDAO{
    ...
    private static final String GET_BY_CODE_COURSES = "SELECT course_num, name FROM Courses WHERE course_num LIKE '%";
    ...
    public List<Course> getCoursesByCode(String code) {
        ...
        ResultSet rs = null;
        try( Connection con = new DataSource().createConnection();
                PreparedStatement pstmt = con.prepareStatement( GET_BY_CODE_COURSES+code+"%'");){
