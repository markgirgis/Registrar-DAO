...
public class StudentsView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StudentsView</title>"); 
            out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"tablestyle.css\">");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StudentsView at " + request.getContextPath() + "</h1>");
            StudentsLogic logic1 = new StudentsLogic();
            List<Student> students = logic1.getAllStudents();
