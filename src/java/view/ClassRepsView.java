...
public class ClassRepsView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ClassRepsView</title>");
            out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"tablestyle.css\">");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ClassRepsView at " + request.getContextPath() + "</h1>");
            ...
            for(ClassRep classRep : ClassReps){
                out.printf("<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>", classRep.getStudentNum(), classRep.getCourseCode(), classRep.getTerm(), classRep.getYear());
            }
            out.println("</table>");
            out.println("</body>");
            out.println("</html>");
